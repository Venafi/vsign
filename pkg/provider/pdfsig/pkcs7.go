...
func getOIDForEncryptionAlgorithm(pKey crypto.PublicKey, OIDDigestAlg asn1.ObjectIdentifier) (asn1.ObjectIdentifier, error) {
	...
	return nil, fmt.Errorf("pkcs7: cannot convert encryption algorithm to oid, unknown key type %T", pKey)
}
